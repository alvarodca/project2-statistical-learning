...
Moreover, BldgType and MSSubClass don't seem to have a really high significance as the rest of models. Based on this graph, we will make a partial dependence plot on Overall Qual as it is clearly the most important variable when classifying, to see how it affects each class.
...
Next, we will compute the ROCs and the AUCs for the tesing data, to interpret and see how the model has performed.
