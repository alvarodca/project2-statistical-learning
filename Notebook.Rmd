...
required_libraries <- c("skimr", "ggplot2","dplyr", "VIM", "dbscan", "RColorBrewer", "isotree" ,"e1071", "bestNormalize","caret", "GGally")
...
We will deal with outliers later as they are a bit complicated to deal with in this dataset due to the distribution of the variables, this distribution can be seen in a graph we made below.
...
This graph clearly shows a positive correlation between the Sale Price and the Area, which makes sense, the bigger the house the bigger the price. Both of these variables seem to also be correlated with the Overall Quality as usually more expensive houses or bigger houses have really good quality.
...
We can see that throughout the years the single family house (1Fam) was the most common house sold. Up until the 1980s two family homes (2fmCon) were also sold and sometimes reached higher sale prices than the single family. From the 1980s onwards there was an increase in the different types and its price at which the houses were sold.
