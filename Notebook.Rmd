...
required_libraries <- c("skimr", "ggplot2","dplyr", "VIM", "dbscan", "RColorBrewer", "isotree" ,"e1071", "bestNormalize","caret", "GGally", "corrplot", "rpart", "rpart.plot")
...
data_not_enc <- data_not_enc %>% select(-SalePrice)
data_enc <- data_enc %>% select(-SalePrice)
```
